...
from MBVMusic.utils.database import get_served_chats_clone
from MBVMusic import userbot
from MBVMusic.core.mongo import mongodb, pymongodb
...
BUTTON = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(
                "๏ ᴋɪᴅɴᴀᴘ ᴍᴇ ๏",
                url=f"https://t.me/MBV_MUSIC_GBOT?startgroup=s&admin=delete_messages+manage_video_chats+pin_messages+invite_users",
            )
        ]
    ]
)
